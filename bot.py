...
class ConfirmCloseView(discord.ui.View):
    def __init__(self, confirm_msg: discord.Message):
...
class CloseView(discord.ui.View):
    ...
    async def close_ticket(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        # Odpovíme ephemeral zprávou jako acknowledge, pak pošleme veřejnou zprávu
        await interaction.response.send_message("_ _", ephemeral=True, delete_after=0)
        msg = await interaction.channel.send(embed=embed)
        view = ConfirmCloseView(confirm_msg=msg)
